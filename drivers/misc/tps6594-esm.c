...
static int __maybe_unused tps6594_esm_suspend(struct device *dev)
{
...
static int __maybe_unused tps6594_esm_resume(struct device *dev)
{
	struct tps6594 *tps = dev_get_drvdata(dev->parent);
...
static SIMPLE_DEV_PM_OPS(tps6594_esm_pm_ops, tps6594_esm_suspend, tps6594_esm_resume);

static struct platform_driver tps6594_esm_driver = {
	.driver	= {
		.name = "tps6594-esm",
		.pm = &tps6594_esm_pm_ops,
	},
